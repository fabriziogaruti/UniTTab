...
from dataset.age2 import TransactionDataset, TransactionDatasetEmbedded
from models.baseline_models_fraud import build_baseline_model
from configs.config_age2 import CONFIG_DICT, CONFIG_FINETUNING, check_configs
from testing.test_utils_fraud import test_fraud_model
from dataset.vocab import EncoderVocab
from evaluation.compute_metrics_fraud import compute_metrics_fraud
...
def main():
    ...
    raw_dataset = TransactionDataset(configs=dataset_configs,
                root=data_root,
                fname=data_fname,
    ...
    training_args = TrainingArguments(
        ...
        per_device_eval_batch_size=15,  # def=8 flat=30 seqlen=15
    ...
    model.eval()
    with torch.no_grad():
        test_fraud_model(model, test_dataset, output_dir)
