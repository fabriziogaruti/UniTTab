...
CONFIG_DICT = {
    ...
    'regression_fields': ['transaction_amt'],
...
def check_configs():
    ...
    if CONFIG_DICT['skip_user'] and 'customer_id' in CONFIG_DICT['columns_to_select']:
        CONFIG_DICT['columns_to_select'].remove("customer_id")
