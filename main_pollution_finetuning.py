...
from testing.test_utils_prsa import test_prsa_model_new
...
def main():
    ...
    dataset = PRSADataset(configs=dataset_configs,
                        root=data_root,
    ...
    _, _, test_dataset = random_split_dataset(dataset, lengths)
    ...
    with torch.no_grad():
        test_prsa_model_new(script_model, test_dataset, output_dir, data_collator)
